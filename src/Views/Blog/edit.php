    ...
    <div class="card-body">
        <form id="blog-update" data-ajax="false">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" name="body" id="body" rows="13" aria-describedby="bodyHelpBlock" required><?= $data['post']['body'] ?></textarea>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <select class="custom-select" name="position" id="position" aria-describedby="positionHelpBlock" required>
                        ...
                        <option value="3" <?php if ($data['post']['position'] == 3) echo 'selected'; ?>>Three</option>
                    </select>
