    ...
    ?>
        <div class="row">
            <div class="col-12 bg-light px-0">
                ...
                <a href="<?= URL_ROOT . '/blog/' . $post['slug']; ?>" class="text-body"><h1 class="display-3 text-center mx-5"><?= $post['title']; ?></h1></a>
                <div class="media">
                    <?php
                    if ($imgSrc !== '') {
                    ?>
    ...
    <nav aria-label="Page navigation" class="custom-pagination mt-3">
        <ul class="pagination justify-content-center">
            <li class="page-item <?php if ($page - 2 <= 1) echo 'disabled'; ?>">
                <a class="page-link" href="<?= URL_ROOT . '/blog?page=' . ($page - 1) ?>" tabindex="-1" <?php if ($page - 2 <= 1) echo 'aria-disabled="true"'; ?>>Previous</a>
            </li>
            <?php
            ...
            <li class="page-item <?php if (($page + 2) * 10 >= count($data['posts'])) echo 'disabled'; ?>">
                <a class="page-link" href="<?= URL_ROOT . '/blog?page=' . ($page + 1) ?>" <?php if (($page + 2) * 10 >= count($data['posts'])) echo 'aria-disabled="true"'; ?>>Next</a>
            </li>
        </ul>
    </nav>
