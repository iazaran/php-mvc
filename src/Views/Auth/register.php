...
<div class="card mx-auto my-3 maxWidth540">
    ...
    <div class="card-body">
        ...
        <p class="mt-4 mb-1">A secret key will send to your email to use for authenticated API access in Authorization header after <code>Bearer </code>. This is an example to get all posts:</p>
